...
export class TenantController {
  ...
  list = async (c: Context) => {
    ...
    const tenants = await this.service.listByHousehold(
      query.householdId,
  ...
  get = async (c: Context) => {
    ...
    const tenant = await this.service.getById(id, currentUserId(c));
  ...
  create = async (c: Context) => {
    ...
    assertHouseholdAdmin(c, body.householdId);
  ...
  remove = async (c: Context) => {
    ...
    assertHouseholdAdmin(c, tenant.householdId);
